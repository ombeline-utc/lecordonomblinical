...
ils ont l’air d’avoir leur propre réalité ludique. `}],Wd="/lecordonomblinical/assets/PP2021-adb1266b.png",Jd={components:{RouterLink:os},watch:{$route(e,s){console.log("2020!"),console.log(Oe)}},data(){return{blocs:Vd,currentScroll:0,currentIndex:0,columnWidth:400,imgPrev:Oe,imgNext:Gs,friseBg:Zs,friseColors:et,progress:0,moisDisponibles:[],img2021:Wd}},computed:{fullText(){return this.blocs.map(e=>e.texte).join(`
...
`}],cp="/lecordonomblinical/assets/PP2022-6275518c.png",dp={components:{RouterLink:os},watch:{$route(e,s){console.log("2022!"),console.log(Oe)}},data(){return{blocs:up,currentScroll:0,currentIndex:0,columnWidth:400,imgPrev:Oe,imgNext:Gs,friseBg:Zs,friseColors:et,progress:0,moisDisponibles:[],img2022:cp}},computed:{fullText(){return this.blocs.map(e=>e.texte).join(`
...
`}],Kp="/lecordonomblinical/assets/PP2024-2aea113f.png",Qp={components:{RouterLink:os},watch:{$route(e,s){console.log("2024!"),console.log(Oe)}},data(){return{blocs:Jp,currentScroll:0,currentIndex:0,columnWidth:400,imgPrev:Oe,imgNext:Gs,friseBg:Zs,friseColors:et,progress:0,moisDisponibles:[],img2024:Kp}},computed:{fullText(){return this.blocs.map(e=>e.texte).join(`
