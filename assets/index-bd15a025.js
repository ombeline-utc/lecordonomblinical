...
surtout je ne me sens plus, au porte et au sortir. 
                ...
                `}],Gs="/assets/PPSuivant-e851b806.png",Zs="/assets/PPLunes - bg-af45c2e2.png",et="/assets/PPLunes - couleurs-1a000ec7.png",wd="/assets/PP2020-f5e5bd01.png",Md={components:{RouterLink:os},watch:{$route(e,s){console.log("2020!"),console.log(Oe)}},data(){return{blocs:Od,currentScroll:0,currentIndex:0,columnWidth:400,imgPrev:Oe,imgNext:Gs,friseBg:Zs,friseColors:et,progress:0,moisDisponibles:[],img2020:wd}},computed:{fullText(){return this.blocs.map(e=>e.texte).join(`
