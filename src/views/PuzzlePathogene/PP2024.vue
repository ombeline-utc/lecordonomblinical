<template>
    <div class="annee-container">
        <img class="annee-img" style="width: 50%" :src="img2024" alt="2024">
        <div>{{img2024}}</div>
    </div>
...
<script>  
    ...
    import texte2024 from '@/ressources/textes/puzzlePathogene/2024.js';
    ...
    import img2024 from '@/ressources/images/puzzlePathogene/PP2024.png';
