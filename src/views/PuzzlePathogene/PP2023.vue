<template>
   <div class="annee-container">
        <img class="annee-img" style="width: 50%" :src="img2023" alt="2023">
        <div>{{img2023}}</div>
    </div>
...
<script>  
    ...
    import texte2023 from '@/ressources/textes/puzzlePathogene/2023.js';
    ...
    import img2023 from '@/ressources/images/puzzlePathogene/PP2023.png';
