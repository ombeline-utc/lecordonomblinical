<template>
    <div class="annee-container">
        <img class="annee-img" style="width: 50%" :src="img2022" alt="2022">
        <div>{{img2022}}</div>
    </div>
...
<script>  
    ...
    import texte2022 from '@/ressources/textes/puzzlePathogene/2022.js';
    ...
    import img2022 from '@/ressources/images/puzzlePathogene/PP2022.png';
