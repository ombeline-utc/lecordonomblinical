<template>
    <div class="annee-container">
        <img class="annee-img" style="width: 50%" :src="img2025" alt="2025">
        <div>{{img2025}}</div>
    </div>
...
<script>  
    ...
    import texte2025 from '@/ressources/textes/puzzlePathogene/2025.js';
    ...
    import img2025 from '@/ressources/images/puzzlePathogene/PP2025.png';
